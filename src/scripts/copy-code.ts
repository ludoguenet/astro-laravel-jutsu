const copyButtonLabel: string = `
  <button type="button" class="inline-flex absolute -top-2 right-2 size-5 rounded-full bg-zinc-900 p-1 text-gray-300 shadow-sm hover:bg-zinc-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-500">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-gray-50 size-3 m-auto">
